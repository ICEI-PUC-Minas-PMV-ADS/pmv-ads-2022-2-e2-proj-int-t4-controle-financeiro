...
||7 - Clicar no botão "+" |
||8 - Clicar no botão "programar lançamento" |
||9 - Clicar no botão "filtrar período" |
||10 - Clicar no período desejado (mês, trimestre, ano) |
||11 - Clicar no pop-up "contas a vencer" |
